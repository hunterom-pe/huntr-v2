            ...
            <div className="grid sm:grid-cols-2 gap-5">
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  ...
                  <input type="email" defaultValue={user?.email || ""} className="input-glass pl-11 bg-slate-50/50" disabled />
                </div>
              </div>
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  ...
                  <input type="text" defaultValue={user?.name || ""} className="input-glass pl-11" />
                </div>
              </div>
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  ...
                  <input type="text" defaultValue={user?.jobTitle || ""} className="input-glass pl-11" />
                </div>
              </div>
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  ...
                  <input type="text" defaultValue={user?.location || ""} className="input-glass pl-11" />
                </div>
              </div>
            </div>
